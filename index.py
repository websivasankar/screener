...
<section class="quant-training" style="padding:20px;border-radius:12px;background:#111827;color:#f3f4f6;line-height:1.8;">

  <h2 style="margin-bottom:10px;font-size:28px;color:#ffffff;">
    Quant Trading Training + InfoAlpha Access
  </h2>

  <p style="font-size:18px;color:#fbbf24;margin-bottom:15px;">
    <strong>Program Fee: ₹8,000 (Full Program)</strong>
  </p>

  <p style="font-size:16px;">
    Learn Price Action, Technical Analysis, Multi-Timeframe Trading,
    Python for Quantitative Research, NSE Data Pipelines, Parquet Workflow,
    Custom Stock Screeners, Quant Models, Sector Rotation Analysis,
    and Options OI Analytics using real NSE market data.
  </p>

  <p style="font-size:16px;">
    Build your own stock analysis software, automate research workflows,
    create systematic trading tools, and understand data-driven market analysis
    instead of relying on buy/sell calls.
  </p>

  <p style="font-size:16px;">
    Includes <strong>InfoAlpha Subscription Access</strong>,
    NSE Screener Dashboard, Research Workflow,
    and <strong>12 Months Free Top Sector + Stock Score Access</strong>.
  </p>
